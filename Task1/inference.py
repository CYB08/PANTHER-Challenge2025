...
class PancreaticTumorSegmentationContainer(SegmentationAlgorithm):
    ...
    def run(self):
        ...
        task = "Dataset091_PantherTask1"
        #move the checkpoints to the nnUNet_results directory
        self.move_checkpoints(self.weights_path, folds="0,1")
    ...
    def move_checkpoints(self, source_dir, folds="0,1", trainer="nnUNetTrainerBLUnet_1000epochs",
                         task="Dataset091_PantherTask1"):
        """
